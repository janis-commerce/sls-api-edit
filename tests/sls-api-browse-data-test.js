...
const { SlsApiEditData } = require('..');

describe('SlsApiEditData', () => {

	describe('getDispatcher', () => {

		it('Should throw when correct params are not given', () => {
			assert.throws(() => SlsApiEditData.getDispatcher());
		});

		it('Should return a Dispatcher instance when correct params are given', () => {

			const dispatcher = SlsApiEditData.getDispatcher({
				entity: 'some-entity',
				action: 'some-action',
				method: 'some-method'
			});
	...
	describe('Handler', () => {
		...
		it('Should pass the request arguments to the Dispatcher and map the dispatcher result', async () => {
			...
			const getDispatcherStub = sandbox.stub(SlsApiEditData, 'getDispatcher');
			...
			const apiResponse = await SlsApiEditData.handler({
				path: {
					entity: 'some-entity',
